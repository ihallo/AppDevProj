...
file_name = 'Balanced_CoffeeDS_500.csv'  # Adjust as necessary
file_path = os.path.join(path, file_name)

# Read the CSV file
df = pd.read_csv(file_path)

st.title("Coffee Dataset")
...
column_descriptions = {
    "Coffee Name": "The name of the coffee drink.",
    "Caffeine Level": "The level of caffeine present in the coffee (e.g., Low, Medium, High).",
    "Sweetness": "The sweetness level of the coffee (e.g., Low, Medium, High).",
    "Type": "Specifies whether the coffee is Iced, Hot, or Frozen.",
    "Roast Level": "The roast level of the coffee beans used (e.g., Light, Medium, Dark).",
    "Milk Type": "The type of milk used in the coffee (e.g., Dairy, Almond, None).",
    "Flavor Notes": "The primary flavor notes of the coffee (e.g., Chocolate, Vanilla, Caramel).",
    "Acidity Level": "The level of acidity in the coffee (e.g., Low, Medium, High).",
    "Bitterness Level": "The level of bitterness in the coffee (e.g., Low, Medium, High).",
    "Weather": "The ideal weather condition for consuming the coffee (e.g., Hot, Cold).",
    "Temperature": "The temperature preference for the coffee (e.g., Hot, Iced, Frozen)."
}
...
caffeine_encoder = LabelEncoder()
sweetness_encoder = LabelEncoder()
type_encoder = LabelEncoder()
roast_encoder = LabelEncoder()
milk_encoder = LabelEncoder()
flavor_encoder = LabelEncoder()
acidity_encoder = LabelEncoder()
bitterness_encoder = LabelEncoder()
weather_encoder = LabelEncoder()
temperature_encoder = LabelEncoder()

df_data['Coffee_encoded'] = coffee_name_encoder.fit_transform(df['Coffee Name'])
df_data['Caffeine_encoded'] = caffeine_encoder.fit_transform(df['Caffeine Level'])
df_data['Sweetness_encoded'] = sweetness_encoder.fit_transform(df['Sweetness'])
df_data['Type_encoded'] = type_encoder.fit_transform(df['Type'])
df_data['Roast_encoded'] = roast_encoder.fit_transform(df['Roast Level'])
df_data['Milk_encoded'] = milk_encoder.fit_transform(df['Milk Type'])
df_data['Flavor_encoded'] = flavor_encoder.fit_transform(df['Flavor Notes'])
df_data['Acidity_encoded'] = acidity_encoder.fit_transform(df['Acidity Level'])
df_data['Bitterness_encoded'] = bitterness_encoder.fit_transform(df['Bitterness Level'])
df_data['Weather_encoded'] = weather_encoder.fit_transform(df['Weather'])
df_data['Temperature_encoded'] = temperature_encoder.fit_transform(df['Temperature'])
...
# --------------------------------------------------------> Hanggang dito palang natatapos ko -Alex
